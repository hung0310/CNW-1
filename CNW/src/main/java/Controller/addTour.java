...
public class addTour extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    protected void doPost(HttpServletRequest request, HttpServletResponse response)
	        ...
	        String uploadPath = "D:/java_web/workspace/CNW/src/main/webapp/images"; // Đường dẫn tuyệt đối đến thư mục lưu trữ ảnh
	        ...
	        boolean insertSuccess = func.addTour(location, description, numberOfDays, fileName);

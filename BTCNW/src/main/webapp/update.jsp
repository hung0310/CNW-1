...
<form action="updateServlet" method="post" class="container mt-5 form" enctype="multipart/form-data" name="updateForm" onsubmit="return validateForm()">
  ...
  <div class="col-md-6">
      <div class="mb-3">
        ...
        <input style="border: 1px solid black; border-radius: 10px;" type="text" class="form-control" id="idtour" name="idtour" value="<%=tour.getId()%>" readonly="readonly">
      </div>
    </div>
    <div class="col-md-6">
      <div class="mb-3">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="oldimage" name="oldimage" value="<%=tour.getImage() %>" readonly="readonly">
      </div>
      <div class="mb-3">
